...
import AddFileView from './add-file-view';
...
export default {
	...
	activate(state) {
		...
		this.addFileView = new AddFileView(state.addFileView);
		this.modalPanel = atom.workspace.addModalPanel({
			item: this.atomVxView.getElement(),
			visible: false
		});
		this.addFileDialog = atom.workspace.addModalPanel({
			item: this.addFileView.getElement(),
			visible: false
		});
